    ...
    if message.attachments:
        ...
        for attachment in message.attachments:
            ...
            if attachment.filename:
                ...
                sha256_hash = hash_file(attachment.filename, hashlib.sha256())
                md5_hash = hash_file(attachment.filename, hashlib.md5())
                sha1_hash = hash_file(attachment.filename, hashlib.sha1())
                ...
                embed.add_field(name="MD5", value=md5_hash)
                embed.add_field(name="SHA1", value=sha1_hash)
                embed.add_field(name="SHA256", value=sha256_hash)
